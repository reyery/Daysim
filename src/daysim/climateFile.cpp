	...
	if (ClimateFileFormat==GLOBAL_DIFFUSE_EPW)
	{
		...
		for (day=0; day<365; day++)
		{
			for (hour=0; hour<24; hour++)
			{
				...
				fscanf(InputFile,"%f,%f,%f,%f,%f,%s",&n1,&n2,&n3,&n4,&n5,&line_string);
				//replace ',' with ' '
				for (i=0;i<1000;i++){
					if(line_string[i] == ',')
						line_string[i] = ' ';
				}
				if (sscanf(line_string,"%s %f %f %f %f %f %f %f %f %f  %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f",&s7,&n7,&n8,&n9,&n10,&n11,&n12,&n13,&n14,&n15,&n16,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1,&n1)== EOF)
				{
					// ran out of file
